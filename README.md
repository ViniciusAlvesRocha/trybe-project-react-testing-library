...
*Nome* | *Avaliação*
--- | :---:
App mutation test | :heavy_check_mark:
About mutation test | :heavy_check_mark:
FavoritePokemons mutation test | :heavy_check_mark:
NotFound mutation test | :heavy_check_mark:
Pokemon mutation test | :heavy_check_mark:
Pokedex mutation test | :heavy_check_mark:
PokemonDetails mutation test | :heavy_check_mark:
